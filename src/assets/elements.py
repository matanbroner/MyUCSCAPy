my_ucsc_elements = {
    ...
    'lab_sections_table': '//*[@id="SSR_CLS_TBL_R2$scroll$0"]/tbody/tr[2]/td/table/tbody',
    'submit_sections_button': 'DERIVED_CLS_DTL_NEXT_PB',
    'auto_waitlist_checkbox': 'DERIVED_CLS_DTL_WAIT_LIST_OKAY$125$',
